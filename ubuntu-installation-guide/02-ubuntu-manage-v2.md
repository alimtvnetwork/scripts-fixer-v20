...
Enables clipboard sharing, proper scrolling and host folder mounting inside a VMware guest, then links the shares to your desktop.
...
grep -q 'vmhgfs-fuse' /etc/fstab || echo '.host:/ /mnt/hgfs fuse.vmhgfs-fuse allow_other,auto_unmount,defaults 0 0' | sudo tee -a /etc/fstab
