...
This guide provides a comprehensive, step-by-step procedure for managing and configuring an CentOS system from scratch. Any AI or developer can follow these instructions to replicate the environment.
...
CentOS's default shell is bash, but we upgrade to ZSH for improved productivity.
- Install ZSH:
  ```bash
