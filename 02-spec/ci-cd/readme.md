...
| Release pipeline spec      | `02-spec/release-pipeline/readme.md` | High-level packaging documentation            |
...
- `release.ps1` produces `dev-tools-setup-v0.27.0.zip` while the README and
  `.ai-memory/overview.md` claim a different version.
...
- All scripts that allocate temp directories must use `try/finally` for
  cleanup. Add this to `.ai-memory/strictly-avoid.md` as a forbidden
...
- [ ] Documentation in `02-spec/release-pipeline/readme.md` references this
...
- High-level packaging spec: `02-spec/release-pipeline/readme.md`
- Version bumper spec       : `02-spec/bump-version/readme.md`
