...
domain: Contract
phase: Scaffold
target_files: [02-spec/21-app/10-k8s-zsh/def_031.md]
...
## 1. Learn
- [spec](02-spec/21-app/00-overview.md) why: context for 6bba5ac2-6165-4250-a110-458dd5791b8f
...
## 2. Goal
Address the specific requirement 6bba5ac2-6165-4250-a110-458dd5791b8f for Definition and consolidation of k8s and zsh spec. Blast radius is isolated to 02-spec/21-app/10-k8s-zsh/def_031.md.

## 3. Inputs and Contracts
Consumes standard cli flags. Produces standard output envelope. Code range: ERR-1031.

## 4. Execute
1. Open 02-spec/21-app/10-k8s-zsh/def_031.md.
2. Implement symbol func_6bba5ac2_6165_4250_a110_458dd5791b8f().
3. Ensure line-by-line append logic for zsh/authorized_keys is utilized here if applicable.

## 5. Constraints
- Must follow rule 6bba5ac2-6165-4250-a110-458dd5791b8f from 02-spec/02-coding-guidelines/00-canonical-size-tier.md.
...
- [ ] Criterion 2: 02-spec/21-app/10-k8s-zsh/def_031.md is written.
