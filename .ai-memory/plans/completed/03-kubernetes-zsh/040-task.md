...
domain: Contract
phase: Scaffold
target_files: [02-spec/21-app/10-k8s-zsh/def_040.md]
...
## 1. Learn
- [spec](02-spec/21-app/00-overview.md) why: context for 660d7867-da9e-4f60-b7d7-219e26eccd91
...
## 2. Goal
Address the specific requirement 660d7867-da9e-4f60-b7d7-219e26eccd91 for Definition and consolidation of k8s and zsh spec. Blast radius is isolated to 02-spec/21-app/10-k8s-zsh/def_040.md.

## 3. Inputs and Contracts
Consumes standard cli flags. Produces standard output envelope. Code range: ERR-1040.

## 4. Execute
1. Open 02-spec/21-app/10-k8s-zsh/def_040.md.
2. Implement symbol func_660d7867_da9e_4f60_b7d7_219e26eccd91().
3. Ensure line-by-line append logic for zsh/authorized_keys is utilized here if applicable.

## 5. Constraints
- Must follow rule 660d7867-da9e-4f60-b7d7-219e26eccd91 from 02-spec/02-coding-guidelines/00-canonical-size-tier.md.
...
- [ ] Criterion 2: 02-spec/21-app/10-k8s-zsh/def_040.md is written.
