---
plan: .ai-memory/plans/pending/01-02-chrome-migration.md
domain: Scripting
phase: Implement
target_files: [scripts/export-chrome-profile.ps1]
depends_on: []
citations:
  app_spec: "02-spec/21-app/04-json-contract/index.md §Section8"
  canonical_size: "02-spec/02-coding-guidelines/00-canonical-size-tier.md"
  language_guideline: "02-spec/02-coding-guidelines/08-file-folder-naming/powershell.md"
  boolean_styling: "02-spec/02-coding-guidelines/01-cross-language/02-boolean-principles/01-naming-prefixes.md"
  folder_naming: "02-spec/02-coding-guidelines/08-file-folder-naming/powershell.md"
  ...
  golden_fixture: "02-spec/21-app/fixtures/chrome-profile-export.example.json"
...
## 1. Learn
- [spec](02-spec/21-app/04-json-contract/index.md) why: rules for PreferencesExportSettings(PS1).
- [style](02-spec/02-coding-guidelines/00-canonical-size-tier.md) why: sizing tier.
- [errors](02-spec/03-error-manage/02-error-architecture/00-overview.md) why: error codes.
...
## 5. Constraints
- Must not exceed canonical size tier (02-spec/02-coding-guidelines/00-canonical-size-tier.md).
- Must handle nulls properly (02-spec/02-coding-guidelines/01-cross-language/19-null-pointer-safety.md).
- Must avoid mutations (02-spec/02-coding-guidelines/01-cross-language/18-code-mutation-avoidance.md).
