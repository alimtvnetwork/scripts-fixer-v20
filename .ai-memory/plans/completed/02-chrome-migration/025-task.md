...
depends_on: []
citations:
  app_spec: "02-spec/21-app/04-json-contract/index.md §Section25"
...
## 1. Learn
- [spec](02-spec/21-app/04-json-contract/index.md) why: rules for ExtensionsPolicyForce-install(SH).
