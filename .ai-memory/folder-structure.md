# Canonical Folder Structure: `.ai-memory/`
...
- `folder-structure.md`: Definitive mapping of `.ai-memory/` folder purposes and lifecycle rules.
...
> **Hard Rule:** Always `.ai-memory/memory/`, NEVER `.ai-memory/memories/` or `memories/`.
...
### 2.6 `02-spec/commands/` (CLI Specifications)
...
3. **No Upper-Case in Paths:** All filenames and folder names under `.ai-memory/` must be lowercase.
