...
## Mitigation
Scanner already excludes `.ai-memory/`, `02-spec/audit/`, and `legacy-fix-report.json`.
...
## Do NOT
Rename strings inside `.ai-memory/solved-issues/` or `02-spec/` just to silence the
