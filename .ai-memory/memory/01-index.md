...
- [Root Dispatcher Modularization](features/12-root-dispatcher-modularization.md) — Decomposition of monolithic 5,814-line run.ps1 into scripts/dispatcher/ modules (v1.48.1+).
