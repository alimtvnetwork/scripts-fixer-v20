...
Prevention: 02-spec/02-coding-guidelines/04-bash/00-overview.md - Always invoke system package managers (`apt`, `snap`) with explicit `sudo` and write idempotent deployment scripts that gracefully skip pre-existing directories.
