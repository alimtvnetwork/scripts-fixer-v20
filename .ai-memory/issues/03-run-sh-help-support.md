...
Prevention: 02-spec/02-coding-guidelines/04-bash/00-overview.md - Always inject standardized `-h` and `--help` trap routines on all CLI interfaces to present available arguments instead of raw failures.
