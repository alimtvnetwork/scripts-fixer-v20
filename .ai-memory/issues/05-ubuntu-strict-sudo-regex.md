...
Prevention: 02-spec/02-coding-guidelines/04-bash/00-overview.md - Always use AST or strict Regex boundaries when bulk-refactoring command permissions, never literal substrings.
