...
Prevention: 02-spec/02-coding-guidelines/04-bash/00-overview.md - Always provide extensionless bash wrappers in the root for CLI tools that emulate multi-platform root commands.
