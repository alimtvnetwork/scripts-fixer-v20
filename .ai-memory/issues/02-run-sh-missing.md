...
Prevention: 02-spec/02-coding-guidelines/04-bash/00-overview.md - Always provide symmetric `.sh` wrappers in the root directory alongside `.ps1` equivalents to prevent friction in cross-platform developer workflows.
