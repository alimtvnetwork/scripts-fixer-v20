...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 46 — Install Kubernetes" width="128" height="128"/>

# Script 46 — Install Kubernetes
...
Implementation folder for **Script 46 — Install Kubernetes**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 46 install
```
...
- [Full spec](../../02-spec/46-install-kubernetes/readme.md)
