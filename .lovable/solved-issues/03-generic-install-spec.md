...
- Authored 7 specification documents under `spec/00-generic-install-script-behavior/` covering strict release-tag mode, main-branch fallback, and versioned discovery across `v1..v20`.
