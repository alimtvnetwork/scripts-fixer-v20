...
- `.lovable/memory/01-index.md` referenced `features/error-management-file-path-rule.md`, which is mapped to the authoritative `spec/error-management/powershell-error-management.md`.
