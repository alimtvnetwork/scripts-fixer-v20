...
# Skip patterns
prune_dirs='-name .git -o -name node_modules -o -name dist -o -name build -o -name .next -o -name .turbo -o -name .cache -o -name coverage -o -name .ai-memory -o -name .legacy-fix-backups'
