...
[![Version](https://img.shields.io/badge/Version-v1.49.0-f97316)](scripts/version.json)
...
# Or use the Linux runner directly for intelligent archive installs (.tar.gz, .zip, .gz, etc.):
